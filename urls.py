...
urlpatterns += patterns('grnglow.glow.views',
    (r'^explore/$', 'explore.localHots'),
    (r'^explore/localhots/$', 'explore.localHots'),
    (r'^explore/localrecents/$', 'explore.localRecents'),
    (r'^explore/globalhots/$', 'explore.globalHots'),
)
...
urlpatterns += patterns('grnglow.glow.views',
    (r'^remote_upload_photo/$', 'home.remote_upload_photo'),
    (r'^remote_edit_avatar/$', 'home.remote_edit_avatar'),
    (r'^remote_delete_photo/$', 'home.remote_delete_photo'),
    (r'^', 'home.error_404'),
)